    ...
    try:
        ...
        for i in range(cantidad_notas):
            try:
                ...
                print("Nota Invalida")
        print("Notas registradas: ", listas_notas)
        promedio=sum(listas_notas)/len(listas_notas)
        print(f"promedio: {promedio}")

    

        if promedio <= 2:
            print("Tu promedio esta muy mal")
        elif promedio <=3:
            print("Tu promedio esta muy basico")
        elif promedio <=4:
            print("Tu promedio es aceptable")
        elif promedio <=5:
            print("Tu promedio es bien")
        else:
            break
